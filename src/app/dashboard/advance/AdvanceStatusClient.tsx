...
import { updateAdvanceStatus, deleteAdvanceRequest } from './actions';

export default function AdvanceStatusClient({ id, currentStatus, t }: { id: string, currentStatus: string, t: any }) {
